...
const Parallax = () => {
  return (
    <section className='bg-[#04050b] font-poppins w-full lg:py-24'>
        ...
        <div class="w-[20%]">
        <div>
            <img alt="Questions" width="243" height="337" class="w-full" src="https://ik.imagekit.io/liquide/tr:w-364.5/images/Questions/sebi.png"/></div>
            
        <div>
            <img alt="Questions" width="243" height="337" class="w-full mt-72" src="https://ik.imagekit.io/liquide/tr:w-364.5/images/Questions/unbiasedImpartial.png"/></div>
         </div>
        <div class="w-[20%]">
        <div><img alt="AI engine" width="243" height="337" class="w-full" src="https://ik.imagekit.io/liquide/tr:w-364.5/images/Questions/aiEngine.png"/>
        </div>
        </div>
        <div class="mt-48 w-[20%]">
            <div>
                <img alt="AI engine" width="243" height="337" class="w-full" src="https://ik.imagekit.io/liquide/tr:w-364.5/images/Questions/alumni.png"/>
            </div>
            <div>
            <img alt="tradeHits" width="243" height="337" class="w-full mt-72" src="https://ik.imagekit.io/liquide/tr:w-364.5/images/Questions/tradeHits.png"/>
            </div>
            </div>
        </div>
       </div>
  ...
  <div className='w-full'>
             ...
             <img alt="Number" width="1215" height="24" class="" src="https://ik.imagekit.io/liquide/tr:w-1822.5/images/updatedPrideNumber.png"></img>
             </div>
           </div>
           </div>
           ...
           <div className='lg:w-4/5 mx-auto overflow-hidden' >
             ...
             <SwiperSlide> 
                 ...
                 <div className='w-[770px] mx-1 pt-10 pb-[24px]' >
                    ...
                    <div>
                        <div>
                        <img alt="profile-pic" width="64" height="64" style={{borderRadius:"50%"}} class="w-11 lg:w-16" src="https://ik.imagekit.io/liquide/tr:w-96/images/testimonials/v2/sakshi-jindal.png"/>
                        </div>
                        <div>
                        <img alt="profile-pic" width="64" height="0" style={{resizeMode:"cover" , borderRadius:"50%"}} className="w-4 h-4 lg:w-7 lg:h-7 absolute left-[90px] bottom-[90px]  border-4 border-black rounded-full" src="https://ik.imagekit.io/liquide/tr:w-96/images/testimonials/v2/indian-flag.png"/>
                        </div>
                    </div>
